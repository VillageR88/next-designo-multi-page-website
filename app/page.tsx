...
export default function Home(): JSX.Element {
  return (
    <main className="mb-[100px] mt-[34px] flex flex-col items-center gap-[120px] md:mb-0 md:mt-[67px] md:px-[39px] screen1024:mb-[-146px] screen1024:gap-[160px] screen1024:[background:no-repeat_calc(50%-12.5em)_320px_url(../public/assets/shared/desktop/bg-pattern-leaf.svg),no-repeat_calc(50%+13.5em)_100%_url(../public/assets/shared/desktop/bg-pattern-leaf180.svg)]">
      <div className="flex min-h-[843px] w-full max-w-[69.375em] justify-center overflow-x-clip px-[24px] pt-[80px] [background-color:#E7816B] [background-image:url(../public/assets/home/desktop/bg-pattern-hero-home.svg),url(../public/assets/home/desktop/image-hero-phone.png)] [background-position:calc(0%)_50%,50%_21em] [background-repeat:no-repeat] before:[transform:rotate(80deg)] sm:pt-[60px] sm:[background-position:calc(0%)_50%,50%_18em] md:rounded-[15px] md:px-0 md:[background-position:calc(100%+5em)_50%,50%_18em] screen1024:min-h-[640px] screen1024:items-center screen1024:justify-normal screen1024:pl-[95px] screen1024:pt-0 screen1024:[background-position:right,calc(100%+5.5em)_-1.8em]">
        <div className="flex max-w-[540px] flex-col items-center gap-[24px] pb-[500px] text-center md:pb-0 screen1024:items-start screen1024:gap-[40px] screen1024:text-start">
